(function () {
    ...
    describe('Todo Controller', function () {
        ...
        var todoList;
        var todoModel = {
            todosLoadedFromEntity: {},
            loadTodos: function(){
                return this.todosLoadedFromEntity;
            },
            saveTodos: function(value){
                this.todosLoadedFromEntity = value;
            },
            addNewTodo: function(newTodo){
                this.todosLoadedFromEntity.push({
                    title: newTodo,
                    completed: false
                });
            },
        ...
        describe('having no Todos', function () {
            ...
            beforeEach(inject(function ($controller) {
                todoModel.todosLoadedFromEntity = [];
                ctrl = $controller('TodoCtrl', {
                    $scope: scope,
                    todoModel: todoModel
                });
        ...
        describe('having some saved Todos', function () {
            ...
            beforeEach(inject(function ($controller) {
                ...
                todoModel.todosLoadedFromEntity = todoList;
                ctrl = $controller('TodoCtrl', {
                    $scope: scope,
                    todoModel: todoModel
                });
            ...
            it('should save Todos to local storage', function () {
                expect(todoModel.todosLoadedFromEntity.length).toBe(5);
            });
